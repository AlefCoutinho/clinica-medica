...
public interface PessoaRepository extends JpaRepository<Pessoa, Long> {
    ...
    /**
     * procura Pessoa com uma determinada descrição sem importar maiúsculas ou
     * minúsculas
     *
     * @param nome
     * @return
    ...
    /**
     * pesquisa Pessoa com um 'pedaço' da descrição independente de maiúsculas
     ...
     * @return
     */
    @Query("select T from Pessoa T where UPPER(T.nome) like UPPER(CONCAT('%', ?1, '%'))")
